...
const OrderHistory: FC = () => {
  ...
  const height = 'calc(100% - 48px)'; // h-12 (48px) 계산하여 높이 설정

  return (
    <div className="flex flex-col w-full h-full bg-[#131722] text-[#72768f] font-semibold border-t-[0.6px] border-[#363A45]">
